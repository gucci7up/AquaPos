      ...
      <section id="pricing" className="py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 items-start">
            <PricingCard 
                title={t('landing.pricing.plans.free')} // "EMPRENDEDOR"
                price="FREE" 
            ...
            />
            <PricingCard 
                title={t('landing.pricing.plans.pro')} // "PROFESIONAL"
                price="$29" 
            ...
            />
            <PricingCard 
                title={t('landing.pricing.plans.growth')} // "CRECIMIENTO"
                price="$79" 
                period={t('landing.pricing.monthly')}
                subText={t('landing.pricing.annual')}
            ...
            />
            <PricingCard 
                title={t('landing.pricing.plans.corp')} // "CORPORATIVO"
                price="Custom" 
...
const PricingCard = ({ title, price, period, subText, btnText, features, popular, isPrimary, primaryColor, onContact }: any) => (
    <div className={`bg-white p-8 rounded-3xl border flex flex-col relative ${isPrimary ? 'border-2 border-primary ring-4 ring-primary/10 scale-105 z-10' : 'border-slate-200'}`} style={isPrimary ? {borderColor: primaryColor, boxShadow: '0 0 0 4px rgba(19,218,236,0.1)'} : {}}>
        ...
        {!subText && <div className="mb-10"></div>} {/* Spacer */}
